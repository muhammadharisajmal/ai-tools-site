...
export default async function DashboardPage() {
  ...
  // Section: Upcoming Disabled Features
  ...
  return (
    <div className="relative min-h-screen font-sans bg-slate-950 text-slate-100 selection:bg-purple-500 selection:text-white antialiased">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-10">
        ...
        {/* 2. YOUR WORKSPACE (ONLY REAL IMPLEMENTED CARDS) */}
        <section className="space-y-4">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Card 3: Platform Status (Informational, No Route) */}
        ...
        {/* 4 & 5: RECENT ACTIVITY & PLATFORM NEWS ROW */}
        ...
        {/* 6. UPCOMING FEATURES (STRICTLY NON-CLICKABLE, NO BUTTONS/LINKS) */}
        <section className="space-y-4">
          <div className="border-b border-slate-800/80 pb-3">
            <h2 className="text-xl font-extrabold text-white tracking-tight flex items-center gap-2">
